...
function ScormProcessInitialize(){
    var result;
    console.log("ScormProcessInitialize");
    API = getAPI();
...
function ScormProcessFinish(){
    console.log("ScormProcessFinish");
    var result;
...
function ScormProcessGetValue(element){
    console.log("ScormProcessGetValue-->");
    console.log("ScormProcessGetValue:element- " + element);
    var result;
    
    if (initialized == false || finishCalled == true){return;}
    
    result = API.LMSGetValue(element);
    console.log("ScormProcessGetValue:result- " + result);
...
function ScormProcessSetValue(element, value){
    console.log("ScormProcessSetValue-->");
    console.log("ScormProcessSetValue:element-->" + element);
    console.log("ScormProcessSetValue:value-->" + value);
    var result;
